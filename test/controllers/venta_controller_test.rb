...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference("Ventum.count") do
      post venta_url, params: { ventum: { cliente_id: @ventum.cliente_id, estado: @ventum.estado, fecha: @ventum.fecha, metodo_pago: @ventum.metodo_pago, total: @ventum.total } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { cliente_id: @ventum.cliente_id, estado: @ventum.estado, fecha: @ventum.fecha, metodo_pago: @ventum.metodo_pago, total: @ventum.total } }
